...
children: [
Text(
'Total ${snapshot.data!.length} items'), // แสดงจาํนวนรายการ
],
),
),
Expanded(
// ส่วนของลิสรายการ
child: snapshot.data!.length > 0 // กาํหนดเงืÉอนไขตรงนีÊ
? ListView.separated(
...
content: Expanded(child: Text("Do you want to delete: " +snapshot.data![index].studentCode),),
actions: <Widget>[TextButton(child: Text('Delete'),
style: TextButton.styleFrom(foregroundColor: Colors.white,
backgroundColor: Colors.redAccent,),
onPressed: () async{
await deleteStudent(snapshot.data![index]);
setState(() {
students=fetchStudents();
});
...
final response =
await http.get(Uri.parse('http://172.21.64.1/Lab7 9.26/api/student.php'));
...
Uri.parse('http://http://172.21.64.1/Lab7 9.26/api/student.php?student_code=${student.studentCode}'),
